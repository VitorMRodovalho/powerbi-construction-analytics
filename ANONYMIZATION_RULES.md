...
| ERP integration references | `ERP_INTEGRATION` | Replaced third-party ERP integration service names |
| ERP vendor references | `ERP vendor` | Replaced ERP vendor company names |
...
- [ ] No ERP vendor or integration service names remain
